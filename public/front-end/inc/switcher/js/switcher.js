			...
			"<div class='switcherContents'>"+
				...
				"<div class='switcherContent skinsColor'>"+
					"<ul class='demo-content demo-color'>"+
                        ...
                        "<li data-name='gnrl_color' data-value='blue' data-value-2='3498db' style='background-image: linear-gradient(to right, #ef3e0f, #ffb800);'></li>"+
    					...
    					"<li data-name='gnrl_color' data-value='pink' data-value-2='ff6b6b' style='background-image: linear-gradient(to right, #4facfe 0%, #00f2fe 100%);'></li>"+
