                ...
                <div class="card-body">
                    <div class="bg-white rounded shadow-sm py-20 px-10 px-lg-20">
                        ...
                        <div class="d-flex flex-center position-relative">
                            ...
                            <img src="{{asset('template/media/users/user.jpg')}}" class="h-120px" alt="user picture" />
                        </div>
                        <!--end::Icon-->
                        <!--begin::Content-->
                        ...
                        <div class="text-left">
                            <h4 class="font-size-h5 d-block d-block font-weight-bold text-dark-50"><i class="la la-surprise"></i> {{ $user->name }}</h4>
