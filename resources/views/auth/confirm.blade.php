					...
					<div class="container row">
						<div class="col-lg-12 d-flex align-items-center">
							...
							<div class="login-form login-signin">
								<!--begin::Form-->
								<form class="form w-xxl-550px rounded-lg p-20" method="post" action="{{ route('confirm-compte') }}" style="background-color: #fff;">
                                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon input-icon-right">
                                            <input type="password" minlength="8" name="password" id="password-field" class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Mot de passe" required>
                                            <span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon input-icon-right">
                                            <input type="password" minlength="8" name="password_confirmation" id="password-confirm-field"  class="form-control form-control-solid h-auto p-6 rounded-lg" placeholder="Confirmer le mot de passe" required>
                                            <span>
